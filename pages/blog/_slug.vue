<template>
    <div class="main-container">
        ...
        <Breadcrumbs :items="breadcrumbNavigation" breadcrumbTitle="Blog Details" />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="post-feature blog-thumbnail  wow move-up">
                            <img class="img-fluid" :src="data.image" alt="Blog Images">
                        </div>
                        <!-- Post Feature End -->
                    </div>
                            ...
                            <div class="single-blog-item  wow move-up">
                                ...
                                <div class="post-info lg-blog-post-info">
                                    <div class="post-categories text-center">
                                        <n-link to="/blog">{{ data.category }}</n-link>
                                    </div>
                                    ...
                                    <div class="post-meta mt-20 justify-content-center">
                                        <div class="post-author">
                                            <n-link to="/">
                                                <img class="img-fluid avatar-96" src="/images/team/admin.jpeg" alt="thumbnail"> 
                                                Harry Ferguson
                                            </n-link>
                                        </div>
                                        <div class="post-date">
                                        ...
                                        <div class="post-comments">
                                            ...
                                            <n-link to="/" class="smooth-scroll-link">4 Comments</n-link>
                                        </div>
                                    </div>
                                    ...
                                    <div class="post-excerpt mt-15">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="entry-post-tags">
                                                        ...
                                                        <div class="tagcloud">
                                                            <n-link to="/descargables">IT Service</n-link>
                                                            <n-link to="/descargables">IT Service</n-link>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="entry-author">
                                            <div class="author-info">
                                                <div class="author-avatar">
                                                    <img src="/images/team/avatar-06-90x90.jpeg" alt="thumbnail">
                                                    <div class="author-social-networks">
                                                        <div class="inner">
                                                            ...
                                                            <a class="hint--bounce hint--top hint--primary" aria-label="Instagram" href="https://www.linkedin.com/" target="_blank">
                                        ...
                                        <div class="related-posts-wrapper">
                                            ...
                                            <div class="row mtn-30">
                                                <div class="col-lg-6 mt-30">
                                                    ...
                                                    <n-link to="/blog/blog-details" class="single-valid-post-wrapper">
                                                        <div class="single-blog__item">
                                                            <div class="single-valid__thum bg-img" :style="{ backgroundImage: `url('/images/blog/blog-03-370x120.jpg')` }">
                                                            </div>
                                                ...
                                                <div class="col-lg-6 mt-30">
                                                    ...
                                                    <n-link to="/blog/blog-details" class="single-valid-post-wrapper">
                                                        <div class="single-blog__item">
                                                            <div class="single-valid__thum bg-img" :style="{ backgroundImage: `url('/images/blog/blog-05-370x120.jpg')` }">
                                                            </div>
                                                            <div class="post-content">
                                                                <h6 class="post-title font-weight--bold">Designers’ Identities & Social Unconscious Bias</h6>
                                                            </div>
                                        ...
                                        <div class="comment-list-wrapper">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <h4 class="widget-title section-space--mb_50">Comments (1) </h4>
                                                </div>
                                                <div class="col-lg-12">
                                                        ...
                                                        <li class="comment">
                                                            <div class="comment-5">
                                                                <div class="comment-author vcard">
                                                                    <img alt="thumb" src="/images/team/comment-3.jpeg">
                                                                </div>
                                                                <div class="comment-content">
                                                                    ...
                                                                    <div class="comment-actions">
                                                                        ...
                                                                        <button class="comment-reply-link">Reply</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <ol class="children">
