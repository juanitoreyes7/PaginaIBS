exports.ids = [139,9,20,26,27,29,30,34,39,49,50,51];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/_slug.vue?vue&type=template&id=0f57ff2e&
var render = function render() {
  ...
  return _c('div', {
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"blog-pages-wrapper section-space--ptb_100\">", "</div>", [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-12\"><div class=\"post-feature blog-thumbnail wow move-up\"><img" + _vm._ssrAttr("src", _vm.data.image) + " alt=\"Blog Images\" class=\"img-fluid\"></div></div> "), _vm._ssrNode("<div class=\"col-lg-8 ml-auto mr-auto\">", "</div>", [_vm._ssrNode("<div class=\"main-blog-wrap\">", "</div>", [_vm._ssrNode("<div class=\"single-blog-item wow move-up\">", "</div>", [_vm._ssrNode("<div class=\"post-info lg-blog-post-info\">", "</div>", [_vm._ssrNode("<div class=\"post-categories text-center\">", "</div>", [_c('n-link', {
    attrs: {
      "to": "/blog"
    }
  }, [_vm._v(_vm._s(_vm.data.category))])], 1), _vm._ssrNode(" <h3 class=\"post-title text-center\">" + _vm._ssrEscape("\n                                    " + _vm._s(_vm.data.title) + "\n                                ") + "</h3> "), _vm._ssrNode("<div class=\"post-meta mt-20 justify-content-center\">", "</div>", [_vm._ssrNode("<div class=\"post-author\">", "</div>", [_c('n-link', {
    attrs: {
      "to": "/"
    }
  }, [_c('img', {
    ...
    attrs: {
      "src": "/images/team/admin.jpeg",
      "alt": "thumbnail"
    }
  }), _vm._v(" \n                                            Harry Ferguson\n                                        ")])], 1), _vm._ssrNode(" <div class=\"post-date\"><span class=\"far fa-calendar meta-icon\"></span>\n                                        January 14, 2019\n                                    </div> <div class=\"post-view\"><span class=\"meta-icon far fa-eye\"></span>\n                                        346 views\n                                    </div> "), _vm._ssrNode("<div class=\"post-comments\">", "</div>", [_vm._ssrNode("<span class=\"far fa-comment-alt meta-icon\"></span> "), _c('n-link', {
    staticClass: "smooth-scroll-link",
    attrs: {
      "to": "/"
    }
  }, [_vm._v("4 Comments")])], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"post-excerpt mt-15\">", "</div>", [_vm._ssrNode("<p>Creative jobs website and networking platform The Dots has launched the “bias blocker”, a new browsing mode that stops employers being able to see candidates’ photos, names, education and employment history, on the basis that they should be judged on the “quality of their work” only. Will tools like this help to build a more diverse design workforce?</p> <blockquote><p class=\"p1\">We’re on a mission to build a better future where technology creates good jobs for everyone. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse moles dolore eu feugiat..\n                                        </p></blockquote> <p>Regardless of our gender, race, religion, cultural beliefs or education, all of us are biased in some way. This no doubt seeps into recruitment – whether we are subconsciously looking for people we relate to, or we are actively going against this to try to diversify the workplace, personal feelings and opinion are making their way into the hiring process.</p> <p>Positive discrimination – giving an advantage to those from minority backgrounds or discriminated groups to put them on a level playing field with others – can only be a good thing. It increases the diversity of people, and therefore the diversity of ideas, in the workplace.</p> <p>Source: designweek.co.uk</p> "), _vm._ssrNode("<div class=\"entry-post-share-wrap border-bottom\">", "</div>", [_vm._ssrNode("<div class=\"row align-items-center\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-6 col-md-6\">", "</div>", [_vm._ssrNode("<div class=\"entry-post-tags\">", "</div>", [_vm._ssrNode("<div class=\"tagcloud-icon\"><i class=\"fa fa-tags\"></i></div> "), _vm._ssrNode("<div class=\"tagcloud\">", "</div>", [_c('n-link', {
    attrs: {
      "to": "/descargables"
    }
  }, [_vm._v("IT Service")]), _vm._ssrNode(" "), _c('n-link', {
    attrs: {
      "to": "/descargables"
    }
  }, [_vm._v("IT Service")])], 2)], 2)]), _vm._ssrNode(" <div class=\"col-lg-6 col-md-6\"><div id=\"entry-post-share\" class=\"entry-post-share\"><div class=\"share-label\">\n                                                        Share this post\n                                                    </div> <div class=\"share-media\"><span class=\"share-icon far fa-share-alt\"></span> <div class=\"share-list\"><a target=\"_blank\" aria-label=\"Twitter\" href=\"https://twitter.com/\" class=\"hint--bounce hint--top hint--primary twitter\"><i class=\"fab fa-twitter\"></i></a> <a target=\"_blank\" aria-label=\"Facebook\" href=\"https://www.facebook.com/\" class=\"hint--bounce hint--top hint--primary facebook\"><i class=\"fab fa-facebook-f\"></i></a> <a target=\"_blank\" aria-label=\"Linkedin\" href=\"https://www.linkedin.com/\" class=\"hint--bounce hint--top hint--primary linkedin\"><i class=\"fab fa-linkedin\"></i></a></div></div></div></div>")], 2)]), _vm._ssrNode(" <div class=\"entry-author\"><div class=\"author-info\"><div class=\"author-avatar\"><img src=\"/images/team/avatar-06-90x90.jpeg\" alt=\"thumbnail\"> <div class=\"author-social-networks\"><div class=\"inner\"><a aria-label=\"Twitter\" href=\"https://twitter.com/\" target=\"_blank\" class=\"hint--bounce hint--top hint--primary\"><i class=\"fab fa-twitter\"></i></a> <a aria-label=\"Facebook\" href=\"https://www.facebook.com/\" target=\"_blank\" class=\"hint--bounce hint--top hint--primary\"><i class=\"fab fa-facebook-f\"></i></a> <a aria-label=\"Instagram\" href=\"https://www.linkedin.com/\" target=\"_blank\" class=\"hint--bounce hint--top hint--primary\"><i class=\"fab fa-instagram\"></i></a></div></div></div> <div class=\"author-description\"><h6 class=\"author-name\">Owen Christ</h6> <div class=\"author-biographical-info\">\n                                                    Harry Ferguson is an author, blogger, and designer living in a suburb of Washington, DC. When he’s not designing, blogging, or writing, Ferguson can be found with his head in a book or pinning like a madman.\n                                                </div></div></div></div> "), _vm._ssrNode("<div class=\"related-posts-wrapper\">", "</div>", [_vm._ssrNode("<div class=\"row mtn-30\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-6 mt-30\">", "</div>", [_c('n-link', {
    staticClass: "single-valid-post-wrapper",
    attrs: {
      "to": "/blog/blog-details"
    }
  }, [_c('div', {
    staticClass: "single-blog__item"
  }, [_c('div', {
    staticClass: "single-valid__thum bg-img",
    style: {
      backgroundImage: `url('/images/blog/blog-03-370x120.jpg')`
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "post-content"
  }, [_c('h6', {
    staticClass: "post-title font-weight--bold"
  }, [_vm._v("Designers’ Identities & Social Unconscious Bias")])])])])], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-lg-6 mt-30\">", "</div>", [_c('n-link', {
    staticClass: "single-valid-post-wrapper",
    attrs: {
      "to": "/blog/blog-details"
    }
...
/* harmony default export */ var _slugvue_type_script_lang_js_ = ({
  ...
  mounted() {
    this.data = blog.blogPosts.find(blog => blog.slug == this.slug);
  }
