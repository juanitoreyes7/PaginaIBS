...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/sections/BlogStyleOne.vue?vue&type=template&id=6cc233a9&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c;

  return _c('div', {
    staticClass: "blog-section-wrapper section-space--pt_100 section-space--pb_70"
  }, [_vm._ssrNode("<div class=\"container\">", "</div>", [_vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-lg-4 col-md-12 wow move-up\">", "</div>", [_vm._ssrNode("<div class=\"section-title tablet-mb__60 section-space--mb_30 tablet-mt__0 small-mt__0 small-mb__60 mt-30\">", "</div>", [_vm._ssrNode("<h6 class=\"section-sub-title mb-20\">" + _vm._ssrEscape(_vm._s(_vm.data.sectionSubTitle)) + "</h6> <h3 class=\"heading\">" + _vm._s(_vm.data.sectionTitle) + "</h3> "), _vm._ssrNode("<ul class=\"infotechno-blog-list mt-30\">", "</ul>", _vm._l(_vm.data.blogPosts.slice(0, 5), function (blog) {
    return _vm._ssrNode("<li>", "</li>", [_c('n-link', {
      attrs: {
        "to": `/blog/${blog.slug}`
      }
    }, [_vm._v(_vm._s(blog.title))])], 1);
  }), 0)], 2)]), _vm._ssrNode(" "), _vm._l(_vm.data.blogPosts.slice(0, 2), function (blog) {
    return _vm._ssrNode("<div class=\"col-lg-4 col-md-6 wow move-up\">", "</div>", [_vm._ssrNode("<div class=\"single-blog-item blog-grid\">", "</div>", [_vm._ssrNode("<div class=\"post-feature blog-thumbnail\">", "</div>", [_c('n-link', {
      attrs: {
        "to": `/blog/${blog.slug}`
      }
    }, [_c('img', {
    ...
    })])], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"post-info lg-blog-post-info\">", "</div>", [_vm._ssrNode("<div class=\"post-meta\"><div class=\"post-date\"><span class=\"far fa-calendar meta-icon\"></span>" + _vm._ssrEscape("\n                                " + _vm._s(blog.postDate) + "\n                            ") + "</div></div> "), _vm._ssrNode("<h5 class=\"post-title font-weight--bold\">", "</h5>", [_c('n-link', {
      attrs: {
        "to": `/blog/${blog.slug}`
      }
    }, [_vm._v(_vm._s(blog.title))])], 1), _vm._ssrNode(" <div class=\"post-excerpt mt-15\"><p>" + _vm._ssrEscape(_vm._s(blog.desc)) + "</p></div> "), _vm._ssrNode("<div class=\"btn-text\">", "</div>", [_c('n-link', {
      attrs: {
        "to": `/blog/${blog.slug}`
      }
    }, [_vm._v("\n                                Read more \n                                "), _c('i', {
...
// CONCATENATED MODULE: ./components/sections/BlogStyleOne.vue?vue&type=template&id=6cc233a9&

// EXTERNAL MODULE: ./data/blog.json
var blog = __webpack_require__(76);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/sections/BlogStyleOne.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./components/sections/BlogStyleOne.vue?vue&type=script&lang=js&
 /* harmony default export */ var sections_BlogStyleOnevue_type_script_lang_js_ = (BlogStyleOnevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./components/sections/BlogStyleOne.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  sections_BlogStyleOnevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
//# sourceMappingURL=sections-blog-style-one.js.map