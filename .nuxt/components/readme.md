...
- `<CorporateVideo>` | `<corporate-video>` (components/CorporateVideo.vue)
...
- `<FooterVideo>` | `<footer-video>` (components/FooterVideo.vue)
...
- `<HeroInsurance>` | `<hero-insurance>` (components/HeroInsurance.vue)
...
- `<InsuranceModal>` | `<insurance-modal>` (components/InsuranceModal.vue)
...
- `<SectionsAboutBanner>` | `<sections-about-banner>` (components/sections/AboutBanner.vue)
- `<SectionsAboutUsDescription>` | `<sections-about-us-description>` (components/sections/AboutUsDescription.vue)
- `<SectionsAboutUsHero>` | `<sections-about-us-hero>` (components/sections/AboutUsHero.vue)
- `<SectionsAccordionWrapper>` | `<sections-accordion-wrapper>` (components/sections/AccordionWrapper.vue)
- `<SectionsAdvisoryButtons>` | `<sections-advisory-buttons>` (components/sections/AdvisoryButtons.vue)
- `<SectionsAdvisoryButtonsCobranza>` | `<sections-advisory-buttons-cobranza>` (components/sections/AdvisoryButtonsCobranza.vue)
...
- `<SectionsCompañiasSegurosSection>` | `<sections-compañias-seguros-section>` (components/sections/CompañiasSegurosSection.vue)
...
- `<SectionsDirectoresSection>` | `<sections-directores-section>` (components/sections/DirectoresSection.vue)
- `<SectionsExperienciaSection>` | `<sections-experiencia-section>` (components/sections/ExperienciaSection.vue)
...
- `<SectionsFormacionExperienciaSection>` | `<sections-formacion-experiencia-section>` (components/sections/FormacionExperienciaSection.vue)
- `<SectionsFormacionSection>` | `<sections-formacion-section>` (components/sections/FormacionSection.vue)
...
- `<SectionsIBSAppSection>` | `<sections-i-b-s-app-section>` (components/sections/IBSAppSection.vue)
- `<SectionsInfoTechExperience>` | `<sections-info-tech-experience>` (components/sections/InfoTechExperience.vue)
- `<SectionsInsuranceDirectory>` | `<sections-insurance-directory>` (components/sections/InsuranceDirectory.vue)
- `<SectionsInsuranceDirectoryCobranza>` | `<sections-insurance-directory-cobranza>` (components/sections/InsuranceDirectoryCobranza.vue)
- `<SectionsPremiosSection>` | `<sections-premios-section>` (components/sections/PremiosSection.vue)
...
- `<SectionsTerminosCondicionesButton>` | `<sections-terminos-condiciones-button>` (components/sections/TerminosCondicionesButton.vue)
...
- `<SectionsTiposSegurosSection>` | `<sections-tipos-seguros-section>` (components/sections/TiposSegurosSection.vue)
