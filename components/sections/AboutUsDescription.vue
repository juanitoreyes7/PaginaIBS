<template>
    <div class="about-us-description section-space--ptb_100">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-description-content">
                        <h1 class="about-description-title">IBS CONSULTORES</h1>
                        <h2 class="about-description-subtitle">Acerca de nosotros</h2>
                ...
                <div class="col-lg-6">
                    <div class="about-description-logo">
                        <div class="logo-display">
                            <img 
                                src="/images/logo/logoIBS.png" 
                                alt="IBS Consultores Logo"
                                class="logo-image"
...
.logo-placeholder {
    ...
    .logo-banner {
        ...
        border-radius: 20px;
        padding: 40px 30px;
        box-shadow: 0 15px 40px rgba(0, 47, 166, 0.3);
        text-align: center;
        position: relative;
        overflow: hidden;
